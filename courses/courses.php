...
<html>
    ...
    <div class="container">
        ...
        <?php
                    ...
                    if(mysqli_num_rows($result) > 0)
                            {
                                echo "<table class='table table-bordered table-hover' style='border-color:black'>";
                                    ...
                                    while( $row = mysqli_fetch_array($result) )
                                    {
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "
                                            <td>
                                                <a href='update_courses.php?course_id=".$row['course_id']."'><img src='../img/edit.jpg'/></a>
                                ...
                                echo "<a href='create_course.php' class='btn btn-primary'>Add New</a>";
                            }
                            else
                            {
            ...
            if($char[0] == 'S')
            {
                $query = "SELECT * from courses WHERE erp='".$_SESSION['id']."' ";
                $result = mysqli_query($link , $query);
        ...
        <script type="text/javascript">
            ...
            $(".edit-btn").click(function() {
                ...
                $("#confirm-del").click(function() {
                    var id=course_id;
                    $("#confirm-del").html('<a href="del_courses.php?course_id=' + id + '">Delete</a>');
                });
            });
